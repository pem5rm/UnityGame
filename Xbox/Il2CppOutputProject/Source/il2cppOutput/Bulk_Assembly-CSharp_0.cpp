...
extern const uint32_t PlayerController_Jump_m824721926_MetadataUsageId;
...
extern "C"  void PlayerController_Move_m3894814615 (PlayerController_t2064355688 * __this, float ___horizonalInput0, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
extern "C"  void PlayerController_Jump_m824721926 (PlayerController_t2064355688 * __this, const RuntimeMethod* method) IL2CPP_METHOD_ATTR;
...
extern "C"  void InstantiateBullet_InstantiateObject_m1946908393 (InstantiateBullet_t2967190384 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		// var x = Input.GetAxis("Horizontal2");
		IL2CPP_RUNTIME_CLASS_INIT(Input_t1431474628_il2cpp_TypeInfo_var);
		Input_GetAxis_m4009438427(NULL /*static, unused*/, _stringLiteral4105162317, /*hidden argument*/NULL);
		// var y = Input.GetAxis("Vertical2");
		Input_GetAxis_m4009438427(NULL /*static, unused*/, _stringLiteral2167972859, /*hidden argument*/NULL);
		...
		Vector3__ctor_m3353183577((&L_13), L_6, L_9, ((float)il2cpp_codegen_subtract((float)L_12, (float)(2.0f))), /*hidden argument*/NULL);
		NullCheck(L_3);
		Transform_set_position_m3387557959(L_3, L_13, /*hidden argument*/NULL);
		// bulletPrefab.GetComponent<Rigidbody2D>().velocity = transform.up * bulletSpeed;
		NullCheck(L_2);
		Rigidbody2D_t939494601 * L_14 = GameObject_GetComponent_TisRigidbody2D_t939494601_m2767154013(L_2, /*hidden argument*/GameObject_GetComponent_TisRigidbody2D_t939494601_m2767154013_RuntimeMethod_var);
		...
		float L_17 = __this->get_bulletSpeed_3();
		IL2CPP_RUNTIME_CLASS_INIT(Vector3_t3722313464_il2cpp_TypeInfo_var);
		...
		NullCheck(L_14);
		Rigidbody2D_set_velocity_m2898400508(L_14, L_19, /*hidden argument*/NULL);
		// }
		return;
	}
}
...
extern "C"  void PlayerController_FixedUpdate_m1610259746 (PlayerController_t2064355688 * __this, const RuntimeMethod* method)
{
	...
	}
	{
		...
		PlayerController_Move_m3894814615(__this, L_0, /*hidden argument*/NULL);
	...
	{
		// Jump();
		PlayerController_Jump_m824721926(__this, /*hidden argument*/NULL);
	}
...
// System.Void PlayerController::Move(System.Single)
extern "C"  void PlayerController_Move_m3894814615 (PlayerController_t2064355688 * __this, float ___horizonalInput0, const RuntimeMethod* method)
{
	...
	memset(&V_0, 0, sizeof(V_0));
	{
		...
		Rigidbody2D_t939494601 * L_4 = __this->get_myBody_6();
		Vector2_t2156229523  L_5 = V_0;
		NullCheck(L_4);
		Rigidbody2D_set_velocity_m2898400508(L_4, L_5, /*hidden argument*/NULL);
		// }
		return;
	}
}
// System.Void PlayerController::Jump()
extern "C"  void PlayerController_Jump_m824721926 (PlayerController_t2064355688 * __this, const RuntimeMethod* method)
{
	static bool s_Il2CppMethodInitialized;
	if (!s_Il2CppMethodInitialized)
	{
		il2cpp_codegen_initialize_method (PlayerController_Jump_m824721926_MetadataUsageId);
		s_Il2CppMethodInitialized = true;
	}
	{
		// if (_shortcutFromPlayerControllerToGroundCheck.isGrounded)
		GroundCheck_t2401657261 * L_0 = __this->get__shortcutFromPlayerControllerToGroundCheck_9();
		NullCheck(L_0);
		bool L_1 = L_0->get_isGrounded_2();
		if (!L_1)
		{
			goto IL_0064;
		}
	}
	{
		...
		Rigidbody2D_t939494601 * L_2 = __this->get_myBody_6();
		Rigidbody2D_t939494601 * L_3 = __this->get_myBody_6();
		NullCheck(L_3);
		Vector2_t2156229523  L_4 = Rigidbody2D_get_velocity_m366589732(L_3, /*hidden argument*/NULL);
		float L_5 = L_4.get_x_0();
		Vector2_t2156229523  L_6;
		memset(&L_6, 0, sizeof(L_6));
		Vector2__ctor_m3970636864((&L_6), L_5, (0.0f), /*hidden argument*/NULL);
		NullCheck(L_2);
		Rigidbody2D_set_velocity_m2898400508(L_2, L_6, /*hidden argument*/NULL);
		// myBody.velocity += jumpVelocity * Vector2.up;
		Rigidbody2D_t939494601 * L_7 = __this->get_myBody_6();
		Rigidbody2D_t939494601 * L_8 = L_7;
		NullCheck(L_8);
		Vector2_t2156229523  L_9 = Rigidbody2D_get_velocity_m366589732(L_8, /*hidden argument*/NULL);
		float L_10 = __this->get_jumpVelocity_3();
		IL2CPP_RUNTIME_CLASS_INIT(Vector2_t2156229523_il2cpp_TypeInfo_var);
		Vector2_t2156229523  L_11 = Vector2_get_up_m2647420593(NULL /*static, unused*/, /*hidden argument*/NULL);
		Vector2_t2156229523  L_12 = Vector2_op_Multiply_m3294489634(NULL /*static, unused*/, L_10, L_11, /*hidden argument*/NULL);
		Vector2_t2156229523  L_13 = Vector2_op_Addition_m800700293(NULL /*static, unused*/, L_9, L_12, /*hidden argument*/NULL);
		NullCheck(L_8);
		...
		GroundCheck_t2401657261 * L_14 = __this->get__shortcutFromPlayerControllerToGroundCheck_9();
		NullCheck(L_14);
		L_14->set_isGrounded_2((bool)0);
	}
...
{
	{
		...
		// public float speed = 10, jumpVelocity = 10;
		__this->set_jumpVelocity_3((10.0f));
		MonoBehaviour__ctor_m1579109191(__this, /*hidden argument*/NULL);
		return;
	}
}
